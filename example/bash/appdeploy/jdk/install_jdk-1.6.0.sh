...
if [ $machine == "x86_64" ]; then
  if [ ! -f jdk1.6.0_45-linux-x64.tar.gz ];then
    wget http://aliyun-dep.oss-cn-beijing.aliyuncs.com/java/jdk1.6.0_45-linux-x64.tar.gz
  fi

  tar zxvf jdk1.6.0_45-linux-x64.tar.gz
  mv jdk1.76.0_45/*  /aliyun/server/java
else
  if [ ! -f jdk1.6.0_45-linux-i586.tar.gz ];then
    wget http://aliyun-dep.oss-cn-beijing.aliyuncs.com/java/jdk1.6.0_45-linux-i586.tar.gz
  fi
  tar zxvf jdk1.6.0_45-linux-i586.tar.gz
  mv jdk1.6.0_45/*  /aliyun/server/java
fi
